...
const MenuItem = ({ iconName, text, onPress, isActive = false, isLogout = false }) => (
    ...
    >
        ...
        {!isLogout && <Ionicons name="chevron-forward-outline" size={18} color="#999" />}
    </TouchableOpacity>
);
...
const PurchaseCard = ({ purchase }) => (
    <View style={styles.purchaseCard}>
        <View style={styles.cardImageContainer}>
            <Image
                source={{ uri: purchase.productImage || 'https://i.imgur.com/J8iL34j.png' }}
        ...
        <View style={styles.cardPriceSection}>
            <Text style={styles.cardPriceText}>R$ {purchase.price?.toFixed(2)}</Text>
    ...
    const loadPurchases = async () => {
        try {
            ...
            const purchasesData = querySnapshot.docs.map(doc => ({
                id: doc.id,
                ...doc.data(),
                date: doc.data().createdAt?.toDate().toLocaleDateString('pt-BR') || 'Data desconhecida'
            }));
        ...
        if (activeSection === 'historico') {
            return (
                <>
                    ...
                    <ScrollView contentContainerStyle={styles.purchasesGrid} style={{ flex: 1 }}>
                        {loading ? (
                    ...
                    <TouchableOpacity style={styles.buyAgainButton} onPress={handleBuyAgain}>
                        <Text style={styles.buyAgainButtonText}>COMPRAR ITENS NOVAMENTE</Text>
                    </TouchableOpacity>
                </>
            );
        }
        ...
        <View style={styles.container}>
            <View style={styles.sidebar}>
                <View style={styles.profileSection}>
                    ...
                    <Text style={styles.profileRole}>{userData?.userType || "Comprador"}</Text>
                </View>
